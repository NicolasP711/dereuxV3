 ...
 */
final class Version20210825065103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artwork (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, title VARCHAR(150) NOT NULL, description VARCHAR(3000) NOT NULL, picture VARCHAR(50) NOT NULL, artist VARCHAR(150) NOT NULL, creation_date DATE DEFAULT NULL, publication_date DATETIME NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_881FC576989D9B62 (slug), INDEX IDX_881FC576F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
